      ...
      <div class="col-md-5 col-lg-8">
        <form action="#" method="POST" autocomplete="off" class="justify-content-center border border-5 p-5 mb-5"
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-lg border-4" id="ingrediente3" name="ingrediente[]">
          </div>
    ...
    btnMas.addEventListener('click', e => {
      ...
      btnMas.insertAdjacentHTML("beforebegin",
        `<div class="mb-3">
            ...
            <input type="text" class="form-control form-control-lg border-4" id="ingrediente${inputNumber}" name="ingrediente[]">
          </div>`
      )
    })
